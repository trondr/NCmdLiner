...
* Install .NET Core 1.0.0 - VS 2015 Tooling Preview 2 (https://go.microsoft.com/fwlink/?LinkId=817245)
* Install Mono 4.4 (http://www.mono-project.com/download/) + Run ..\tools\Mono Target\Mono Target.cmd
* Run .\Build.cmd
