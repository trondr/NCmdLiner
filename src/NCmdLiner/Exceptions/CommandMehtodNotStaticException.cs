// File: CommandMehtodNotStaticException.cs
...
{
    public class CommandMehtodNotStaticException : NCmdLinerException
    {
        public CommandMehtodNotStaticException(string message) : base(message)
        {
        }
    }
}