// File: InvalidCommandParameterFormatException.cs
...
{
    public class InvalidCommandParameterFormatException : NCmdLinerException
    {
        public InvalidCommandParameterFormatException(string message)
            : base(message)
        {
        }
    }
